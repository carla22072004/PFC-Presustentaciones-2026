...
1. **P1 — Usabilidad y Experiencia de Usuario (SUS A+):** Implementación de interfaz reactiva SPA en Angular 19 validada formalmente mediante el cuestionario *System Usability Scale* (SUS) con 10 evaluadores independientes, obteniendo un puntaje de **91.25 / 100 (Grado A+ - Excelente / Best in Class)**.
...
- **Puntaje Promedio Global:** **91.25 / 100**
...
| **C7. Calidad y Usabilidad**| 15 % | Estudio SUS (91.25 A+), Docker en 1 comando, JaCoCo, k6 y Makefile. | ✅ Cumplido |
