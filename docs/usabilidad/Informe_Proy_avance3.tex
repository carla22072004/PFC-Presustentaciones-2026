...
\begin{enumerate}
    \item \textbf{P1 --- Usabilidad y Experiencia de Usuario (SUS A+):} Implementación de interfaz reactiva SPA en Angular 19 validada formalmente mediante el cuestionario \textit{System Usability Scale} (SUS) con 10 evaluadores independientes, obteniendo un puntaje de \textbf{91.25 / 100 (Grado A+ - Excelente)}.
...
\textbf{OBS-07} & 1B & Falta de evidencias empíricas de calidad y usabilidad. & Suite JaCoCo ($>60\%$), k6 carga, auditoría OWASP Top 10 y estudio de usabilidad SUS (91.25). & \texttt{f1a23b4} & \textbf{Resuelto} \\ \hline
\end{tabular}
\end{table}
...
Para garantizar la usabilidad del sistema, se realizó una evaluación formal aplicando la metodología estandarizada de Brooke (1996) con 10 participantes independientes (estudiantes, docentes y profesionales IT).
...
\vspace{0.2cm}
\noindent \textbf{Puntaje SUS Promedio Global:} \textbf{91.25 / 100} $\longrightarrow$ \textbf{Clasificación: Grado A+ (Excelente / Best in Class)}.
...
\textbf{C7. Calidad y Usabilidad} & 15 \% & Estudio SUS (91.25 A+), Docker en 1 comando, JaCoCo, k6 y Makefile. & Entrega correcta con evidencias parciales. & Arranca solo con intervención manual. & No arranca desde clonación limpia. \\ \hline
\end{tabular}
\end{table}
