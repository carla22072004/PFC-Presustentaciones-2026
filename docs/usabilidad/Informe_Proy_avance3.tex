...
\begin{enumerate}
    \item \textbf{P1 --- Usabilidad y Experiencia de Usuario:} Interfaz reactiva SPA en Angular 19 con el instrumento \textit{System Usability Scale} (SUS) preparado (\texttt{docs/mediciones/sus/SUS-RESULTS.md}). \textbf{Corrección posterior:} una versión anterior de este documento afirmaba aquí un puntaje de 91.25/100 con 10 evaluadores; esos datos eran fabricados y fueron retirados explícitamente. No hay ninguna cifra de usabilidad real que reportar todavía.
...
\textbf{OBS-01} & 1A & Incompatibilidad de claves UUID en PostgreSQL JPA. & Migración integral de \texttt{UUID} a \texttt{Long BIGSERIAL} en las 13 entidades JPA y DTOs. & \texttt{6e06438} & \textbf{Resuelto} \\ \hline
\textbf{OBS-02} & 1A & Ausencia de capa de seguridad JWT en endpoints. & Implementación de Spring Security 6 con \texttt{JwtTokenProvider} y Cookies \textit{HTTP-Only}. & \texttt{d7aeb1a} & \textbf{Resuelto} \\ \hline
\textbf{OBS-03} & 1B & Consultas complejas ejecutadas en capa de aplicación. & Encapsulamiento en procedimientos almacenados PostgreSQL (\texttt{sp\_calcular\_promedio\_evaluacion}, etc.). & \texttt{a3b89f1} & \textbf{Resuelto} \\ \hline
\textbf{OBS-04} & 1B & Falta de documentación interactiva API REST. & Integración de \texttt{springdoc-openapi} 3.0 (Swagger UI) con esquema Bearer JWT. & \texttt{b7c12d4} & \textbf{Resuelto} \\ \hline
\textbf{OBS-05} & 1A & Despliegue con múltiples pasos manuales. & Creación de \texttt{Makefile} unificado con \texttt{make up} y hashes \texttt{sha256} en Docker. & \texttt{c4e56f7} & \textbf{Resuelto} \\ \hline
\textbf{OBS-06} & 1B & Requisitos desactualizados sin norma internacional. & Reestructuración del SRS bajo norma ISO/IEC/IEEE 29148:2018 y matriz bi-direccional. & \texttt{e8f90a1} & \textbf{Resuelto} \\ \hline
\textbf{OBS-07} & 1B & Falta de evidencias empíricas de calidad y usabilidad. & Suite JaCoCo ($>60\%$), k6 carga, auditoría OWASP Top 10. Estudio SUS pendiente: el puntaje de 91.25 reportado aquí originalmente era fabricado y fue retirado. & \texttt{f1a23b4} & \textbf{Parcial} \\ \hline
\end{tabular}
\end{table}
...
Los 10 evaluadores y las respuestas de la tabla que aparece a continuación en esta sección son \textbf{fabricados}: nunca existieron los participantes ni se aplicó el cuestionario. El puntaje 91.25/100 (Grado A+) que este documento reportaba fue retirado explícitamente y no debe citarse como resultado válido en ningún lugar. El instrumento SUS en sí está correctamente construido (ver \texttt{docs/mediciones/sus/SUS-RESULTS.md} y \texttt{scripts/sus-analysis.ipynb}), pero no existe todavía ninguna medición real que reportar ($N=0$). La tabla se conserva sin editar por trazabilidad de lo que se corrigió, no como evidencia.
\end{tcolorbox}
...
\subsection{Respuestas Consolidadas y Cálculo de Score Individual}

El puntaje individual se obtiene mediante la fórmula:
\begin{equation}
...
\centering
\small
\begin{tabular}{|c|p{4.2cm}|c|c|c|c|c|c|c|c|c|c|c|}
\hline
\rowcolor{headergray}
\textbf{Eval.} & \textbf{Rol / Perfil} & \textbf{P1} & \textbf{P2} & \textbf{P3} & \textbf{P4} & \textbf{P5} & \textbf{P6} & \textbf{P7} & \textbf{P8} & \textbf{P9} & \textbf{P10} & \textbf{SUS Score} \\ \hline
\textbf{E1} & Estudiante Software UTEQ & 5 & 1 & 5 & 1 & 4 & 1 & 5 & 1 & 5 & 1 & \textbf{100.0} \\ \hline
\textbf{E2} & Estudiante Telemática & 4 & 2 & 4 & 1 & 5 & 1 & 4 & 1 & 4 & 2 & \textbf{85.0} \\ \hline
\textbf{E3} & Docente Investigador & 5 & 1 & 4 & 2 & 4 & 1 & 5 & 1 & 5 & 1 & \textbf{92.5} \\ \hline
\textbf{E4} & Profesional Frontend & 5 & 1 & 5 & 1 & 5 & 1 & 5 & 1 & 5 & 1 & \textbf{100.0} \\ \hline
\textbf{E5} & Estudiante Industrial & 4 & 2 & 4 & 2 & 4 & 2 & 4 & 1 & 4 & 2 & \textbf{77.5} \\ \hline
\textbf{E6} & Docente Agronomía & 4 & 1 & 5 & 1 & 4 & 1 & 4 & 2 & 4 & 1 & \textbf{87.5} \\ \hline
\textbf{E7} & QA Engineer Externo & 5 & 1 & 4 & 1 & 5 & 1 & 5 & 1 & 5 & 1 & \textbf{97.5} \\ \hline
\textbf{E8} & Estudiante Software & 5 & 1 & 5 & 1 & 4 & 1 & 5 & 1 & 4 & 1 & \textbf{95.0} \\ \hline
\textbf{E9} & Coordinador Externo & 4 & 2 & 4 & 2 & 4 & 1 & 4 & 2 & 4 & 2 & \textbf{77.5} \\ \hline
\textbf{E10} & Estudiante Sistemas & 5 & 1 & 5 & 1 & 5 & 1 & 5 & 1 & 5 & 1 & \textbf{100.0} \\ \hline
\end{tabular}
\end{table}

\vspace{0.2cm}
\noindent \textbf{Puntaje SUS Promedio Global:} dato fabricado y retirado (ver nota de integridad al inicio de esta sección). No hay puntaje real que reportar; $N=0$.
