...
Una versión anterior de esta sección presentaba una tabla con 10 evaluadores \textbf{fabricados} (E1--E10) y sus puntajes individuales inventados: nunca existieron esos participantes ni se aplicó el cuestionario. El puntaje 91.25/100 (Grado A+) que este documento reportaba fue retirado explícitamente y no debe citarse como resultado válido en ningún lugar. Esa tabla fue \textbf{eliminada por completo} (2026-09-11), no solo anotada. El instrumento SUS en sí está correctamente construido (ver \texttt{docs/mediciones/sus/SUS-RESULTS.md} y \texttt{scripts/sus-analysis.ipynb}), pero no existe todavía ninguna medición real que reportar ($N=0$).
\end{tcolorbox}
