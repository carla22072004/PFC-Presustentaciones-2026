...
| Un identificador único y persistente (DOI, hash de commit) referencia cada versión de los datos | ✅ | El software tiene DOI de concepto `10.5281/zenodo.21988563` (versión actual `v1.0.1`: `10.5281/zenodo.22445216`; versión anterior `v1.0.0`: `10.5281/zenodo.21988564` — `../ZENODO.md`) y el dataset de mediciones fue depositado por separado el 2026-09-05, con su propio DOI `10.5281/zenodo.22398713` (DOI de concepto `10.5281/zenodo.22398712`) y licencia CC-BY 4.0 (`../ZENODO-DATASET.md`), siguiendo el principio de citación independiente entre software y datos. Limitación que se mantiene: el DOI es a nivel de dataset completo, no granular por archivo individual (p. ej. no hay un DOI específico solo para `k6/run3-summary.json`) |
