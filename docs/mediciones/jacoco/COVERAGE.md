...
**Reporte crudo archivado (HTML + XML + CSV):** [`docs/mediciones/jacoco/2026-08-30/`](2026-08-30/) — snapshot real más reciente; [`2026-08-29/`](2026-08-29/) y [`2026-08-17/`](2026-08-17/) se conservan como snapshots históricos. El reporte también se regenera y publica como artefacto en el job `backend` de [`.github/workflows/ci.yml`](../../../.github/workflows/ci.yml) en cada push.
**Última actualización:** 2026-08-30 (auditoría CI/CD, Fase 20-21 — `PreSustentacionesApplicationTests` pasó de `assertTrue(true)` a un `@SpringBootTest` real que levanta el contexto completo de Spring; la cobertura subió unos puntos porcentuales no porque se haya agregado lógica de negocio nueva bajo test, sino porque levantar el contexto real ejecuta constructores/`@PostConstruct`/inicialización de beans que antes nunca se ejecutaban en la suite de tests).
...
| **2026-08-30 (`@SpringBootTest` real, actual)** | **35.10%** (5,699 / 16,237) | **38.88%** (1,173 / 3,017) | **23.06%** (255 / 1,106) | **109 tests / 15 archivos** |
