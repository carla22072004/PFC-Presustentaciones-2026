...
La misma credencial aparece hoy, verificado el 2026-09-11, en \textbf{cuatro} lugares del
repositorio público: el código que siembra los datos de demostración, la colección de peticiones
de \cd{docs/postman/}, el escenario de ejemplo de \cd{docs/requisitos/historias/HU-01.md} y la
propia documentación de despliegue. OBS-11 dio por retirada la del \cd{README.md} y dejó las
otras tres declaradas como pendientes; este requisito es el que fija cuándo puede considerarse
cerrada. Es el hallazgo de seguridad más serio del punto de corte y encabeza el plan de cierre
(\S\ref{sec:pendientes}).}
