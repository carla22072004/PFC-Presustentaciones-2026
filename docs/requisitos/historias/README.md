...
| [HU-02](HU-02.md) | RF-02 | Registro de solicitud | Must | ❌ Sin prueba dedicada |
| [HU-03](HU-03.md) | RF-03 | Asignación de jurados | Must | ✅ `JuradoServiceImplTest.java` |
| [HU-04](HU-04.md) | RF-04 | Programación de cronograma | Must | ❌ Sin prueba dedicada |
...
**Estado real de verificación de los Must (2026-08-17): 5 de 8 (62.5%)**, no el 100% que exige el
criterio D0R. Los `❌` no son un error de este documento: son el resultado real de correr
[`../../../scripts/validate-traceability.sh`](../../../scripts/validate-traceability.sh) contra el
repositorio — 5 archivos de test que `matriz.csv` citaba nunca existieron (hallazgo de la Fase 6).
Ver [`../../trazabilidad/matriz.csv`](../../trazabilidad/matriz.csv) v1.0.0 para el detalle completo y
