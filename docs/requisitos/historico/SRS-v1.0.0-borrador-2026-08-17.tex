...
\bottomrule
\end{tabular}
\caption{SRS version history. See the full changelog in \texttt{CHANGELOG-REQ.md}.}
\end{table}
...
\bottomrule
\caption{Summary of the 12 functional requirements. Source of truth: \texttt{docs/trazabilidad/matriz.csv} v1.0.0.}
\end{longtable}
