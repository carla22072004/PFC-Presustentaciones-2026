...
RNF-04 & Mantenibilidad & Cobertura JaCoCo $\geq$ 60\%. \textbf{No cumplido}: 37.06\% de líneas real (2026-08-29, 109 tests), en progreso desde 2.83\% (\texttt{docs/mediciones/jacoco/COVERAGE.md}). \\
\bottomrule
\end{tabular}
\end{table}
