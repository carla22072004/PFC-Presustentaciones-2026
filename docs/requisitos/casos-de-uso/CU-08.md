...
2. El sistema invoca `NotificacionServiceImpl.crear(usuarioId, mensaje)`.
...
sequenceDiagram
    ...
    participant NS as NotificacionServiceImpl
...
## Trazabilidad
- **Prueba automatizada:** ❌ `NotificacionServiceImplTest.java` no existe (hallazgo Fase 6).
