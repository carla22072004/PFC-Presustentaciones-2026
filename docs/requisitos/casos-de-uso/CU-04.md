...
sequenceDiagram
    ...
    participant CC as CronogramaController
    participant CS as CronogramaServiceImpl
...
## Trazabilidad
- **Prueba automatizada:** ❌ `CronogramaServiceImplTest.java` no existe (hallazgo Fase 6).
