...
sequenceDiagram
    ...
    participant JC as JuradoController
    participant JS as JuradoServiceImpl
...
## Trazabilidad
- **Prueba automatizada:** ✅ `JuradoServiceImplTest.java` (5 tests, 53% cobertura de líneas real).
