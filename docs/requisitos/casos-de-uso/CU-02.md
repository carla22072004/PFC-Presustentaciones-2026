...
sequenceDiagram
    ...
    participant SC as SolicitudController
    participant SS as SolicitudServiceImpl
...
## Trazabilidad
- **Prueba automatizada:** ❌ `SolicitudServiceImplTest.java` no existe (hallazgo Fase 6).
