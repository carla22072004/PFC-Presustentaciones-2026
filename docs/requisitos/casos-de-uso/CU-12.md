...
sequenceDiagram
    ...
    participant AC as AnteproyectoController
    participant AS as AnteproyectoServiceImpl
...
## Trazabilidad
- **Prueba automatizada:** ✅ `AnteproyectoServiceImplTest.java` (72% cobertura de líneas real).
