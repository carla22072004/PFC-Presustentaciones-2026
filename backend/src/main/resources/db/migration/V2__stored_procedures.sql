...
--    NOTA (fusión de ramas): se probó también una variante con arreglos
--    (BIGINT[]) para asignar el lote en una sola llamada, pero @Procedure de
--    Spring Data JPA no bindea de forma fiable arreglos de PostgreSQL; se
--    mantiene la firma escalar, ya verificada end-to-end incluyendo un caso
--    real de rollback (un par inválido revierte también los ya procesados).
