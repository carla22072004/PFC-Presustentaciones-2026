...
/** Configuración del cronograma de respaldos: se usa tanto para leer como para actualizar. */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class RespaldoConfigDTO {

    @NotNull
    private Boolean activo;

    /** Expresión cron de Spring (6 campos). Se valida con CronExpression.parse antes de guardar. */
    @NotBlank
    private String cron;
