...
| **Registros ADR** | [`docs/adr/`](docs/adr/) | 7 Registros de Decisiones Arquitectónicas (ADR-001 a ADR-007; ADR-007 agregado 2026-08-29, documenta el control de acceso por permisos dinámicos que reemplazó al RBAC estático descrito originalmente en ADR-005). |
