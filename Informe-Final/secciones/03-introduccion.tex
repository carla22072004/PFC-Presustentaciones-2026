...
requisitos funcionales (12 verificados con prueba automatizada real, Sección~\ref{sec:requisitos}), 30
...
\begin{enumerate}[nosep]
    ...
    pre-sustentación, con 15 requisitos funcionales trazados (12 verificados con prueba automatizada
    real).
