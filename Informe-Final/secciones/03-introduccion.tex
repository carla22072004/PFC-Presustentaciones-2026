...
verificable directamente en el repositorio, es el alcance técnico del artefacto construido: 12
requisitos funcionales (Sección~\ref{sec:requisitos}), 25 controladores REST, y la evidencia empírica
completa de la Sección~\ref{sec:evaluacion}.
...
\begin{enumerate}[nosep]
    ...
    pre-sustentación, con 12 requisitos funcionales verificados y trazados.
