...
\begin{enumerate}[nosep]
    ...
    prioridad Could/Should (RF-08, RF-09, RF-10) sin cubrir. Cobertura general de 81.03\,\% de líneas y
    64.39\,\% de ramas (JaCoCo, 2026-09-06, 559 tests), ambas por encima de los objetivos de 60\,\%/70\,\%
    de RNF-04. Las dos capas de lógica de negocio superan el umbral de 70\,\% exigido por la guía en
    líneas \emph{y} en ramas a la vez: controladores pasó de 8.75\,\%/0\,\% a \textbf{72.00\,\%/77.41\,\%},
    y servicios pasó de 59.64\,\%/40.87\,\% a \textbf{87.57\,\%/70.04\,\%}. La brecha de ramas que queda
    a nivel global se concentra en los componentes transversales de seguridad (autenticación, JWT,
    filtros), un módulo más pequeño (261 líneas / 230 ramas combinadas) que no alcanza el umbral
    individualmente y queda declarado como trabajo futuro en vez de omitido.
