...
seguridad del backend. El Anexo C (Sección~\ref{anexo:ci}) declara explícitamente qué evidencia de
corridas reales de este workflow existe hoy y qué falta capturar antes del examen final.
