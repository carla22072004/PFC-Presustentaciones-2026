...
RF-02 & Registro de solicitud & Must & No verificado \\
RF-03 & Asignación de jurados & Must & Verificado (test real) \\
RF-04 & Programación de cronograma & Must & No verificado \\
...
\bottomrule
\end{tabular}
\caption{Los 12 requisitos funcionales, su prioridad MoSCoW y su estado real de verificación
automatizada (fuente: \texttt{docs/trazabilidad/matriz.csv} v1.0.0).}
...
Historia de Usuario, una decisión de estilo consciente, no un descuido), y la característica de conjunto
``verificable como conjunto'' falla porque solo 5 de 8 requisitos Must tienen prueba automatizada real
(62.5\,\%, no el 100\,\% ideal).
