...
El sistema especifica 15 requisitos funcionales (Tabla~\ref{tab:rf-resumen}) y 4 requisitos no
...
\bottomrule
\end{tabular}
\caption{The 15 functional requirements, their MoSCoW priority, and their real automated
...
apropiado, no ambiguo, completo, singular, factible, verificable, correcto, conforme) a los 15 RF, y las
...
último Must que faltaba). A nivel de los 15 requisitos totales del sistema la cifra es 12/15 (80\,\%): RF-08,
