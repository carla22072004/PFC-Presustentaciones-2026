...
\noindent\fbox{\parbox{\textwidth}{\footnotesize\textbf{Nota de integridad bibliográfica:} las 34
...
de la Sección~\ref{sec:arquitectura}; \texttt{arcuri2019} se añadió el 2026-09-06, verificada su cita
exacta --- volumen, número y páginas de TOSEM --- contra el registro real de ACM Digital Library antes de
citarla, no de memoria). \textbf{20 de las 34 (58.8\,\%)} cumplen el criterio estricto de alto impacto
exigido por esta guía (revista Q1/Q2 indexada en Scopus, o actas de ICSE/FSE/ASE/MSR/EASE/ESEM) ---
marcadas con {\dag} abajo, alcanzando el mínimo de 20 solicitado.}}
\vspace{0.5cm}
...
\bibitem{arcuri2019}\dag\ A. Arcuri, ``RESTful API automated test case generation with EvoMaster,'' \textit{ACM Transactions on Software Engineering and Methodology}, vol. 28, no. 1, pp. 1--37, 2019. DOI: 10.1145/3293455.
