...
proyecto como el instrumento de medición de usabilidad planeado (Sección~\ref{sec:evaluacion}), aunque a
la fecha de este informe no se ha aplicado a participantes reales.
...
\texttt{docs/checklists/}. Para la revisión de trabajos relacionados
