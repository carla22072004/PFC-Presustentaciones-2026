...
código llega a 70.00\,\% de líneas (576 pruebas, 0 fallos), superando el 70\,\% en controladores y servicios. Una
...
50 Must-priority requirements have a dedicated test (72\,\%), and code coverage reaches 70.00\,\% of
lines (576 tests, 0 failures), exceeding 70\,\% in both the controller and service layers. A manual review of the
