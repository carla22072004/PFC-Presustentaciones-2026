...
código llega a 69.83\,\% de líneas (576 pruebas), superando el 70\,\% en controladores y servicios. Una
...
50 Must-priority requirements have a dedicated test (72\,\%), and code coverage reaches 69.83\,\% of
lines (576 tests), exceeding 70\,\% in both the controller and service layers. A manual review of the
