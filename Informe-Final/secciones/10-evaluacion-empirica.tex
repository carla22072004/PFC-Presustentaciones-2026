...
\begin{enumerate}[nosep]
    ...
    autenticado; ahora exige ser el propio docente o tener rol administrativo.
...
JaCoCo sobre 228 pruebas automatizadas reales (2026-09-04): 43.3\,\% de instrucciones (8,493/19,614),
47.5\,\% de líneas (1,822/3,839), 34.9\,\% de ramas (506/1,448) --- por debajo del umbral RNF-04 de
60\,\%, pero con progreso real y verificable respecto a la medición anterior de este mismo informe
(109 tests; 35.10\,\%/38.88\,\%/23.06\,\%): +119 tests, y las tres métricas suben (+8.2\,pp
instrucciones, +8.6\,pp líneas, +11.8\,pp ramas), no solo el numerador --- el denominador también creció
porque se agregó código de producción real en el mismo periodo (Sección~\ref{sec:seguridad-corregida}).
