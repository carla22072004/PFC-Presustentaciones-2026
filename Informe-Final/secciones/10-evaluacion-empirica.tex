...
JaCoCo sobre 228 pruebas automatizadas reales (2026-09-05, \texttt{mvn clean verify} sobre Postgres/Redis
reales en Docker, ver \texttt{docs/mediciones/jacoco/2026-09-05/}): 44.39\,\% de instrucciones
(9,303/20,957), 48.03\,\% de líneas (1,866/3,885), 32.07\,\% de ramas (506/1,578) --- por debajo del
umbral RNF-04 de 60\,\%, pero con progreso real y verificable respecto a la medición anterior de este
mismo informe (109 tests; 35.10\,\%/38.88\,\%/23.06\,\%): +119 tests, y las métricas de instrucciones y
líneas suben (+9.3\,pp instrucciones, +9.2\,pp líneas), no solo el numerador --- el denominador también
creció porque se agregó código de producción real en el mismo periodo
(Sección~\ref{sec:seguridad-corregida}). La cobertura de ramas también sube frente a esa misma medición
(+9.0\,pp, a 32.07\,\%) aunque queda por debajo de una cifra intermedia no versionada (34.9\,\%) que una
versión previa de este párrafo citaba sin archivo crudo respaldándola en el repositorio --- se reemplaza
aquí por la única cifra que hoy se puede recalcular desde un CSV versionado.
