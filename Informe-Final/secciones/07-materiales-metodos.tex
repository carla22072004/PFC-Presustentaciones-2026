...
2. Definir los objetivos de una solución & 90 requisitos priorizados MoSCoW, 64 funcionales y 26 no funcionales (Sección~\ref{sec:requisitos}) \\
...
\bottomrule
\end{tabular}
\caption{Instantiation of the Peffers et al. DSR process model \cite{peffers2007}.}
\label{tab:dsr}
\end{table}
...
\bottomrule
\end{tabular}
\caption{GQM scheme for the caching system's performance goal.}
\label{tab:gqm}
\end{table}
